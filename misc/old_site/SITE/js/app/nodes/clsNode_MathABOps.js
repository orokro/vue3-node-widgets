...
//MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS
clsNode_MathABOps = function(props){

		//save our type name
		this.typeName = 'MathABOps';
	...
	//CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION
		...
		this.NODE.setTitle('Math &#9658; AB Ops');
		...
		this.NODE.addAttribute({'caption':'Operation:',			'CTRLType':'DROPBOX', 																								'CRTLProps':{'items':['[ + ] Add', '[ - ] Subract', '[ x ] Multiply', '[ &#247; ] Divide', '[ % ] Modulus', '[ ^ ] Expontent' , 'log A base B']}	}	);
...
//GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS
	...
	clsNode_MathABOps.prototype.getModelAttrs = function(){
		return {
...
//GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS
	...
	clsNode_MathABOps.prototype.model = function(inputs){
		...
		var output = null;
			...
			switch(parseInt(Op)){
				...
				case 6: //log A of base B
					output = Math.log(A) / Math.log(B);
					break;
			}//swatch function
	...
	clsNode_MathABOps.prototype.update = function(){
...
//EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS
	...
	clsNode_MathABOps.prototype.raiseEvent = {};


	//CHANGE EVENT +++ CHANGE EVENT +++ CHANGE EVENT
	clsNode_MathABOps.prototype.raiseEvent.change = function(me){
	...
	clsNode_MathABOps.prototype.onChange = function(callBackFunction){
...
nodeCreationMenu.registerNodeMenuItem('AB Operations', ['Math'], clsNode_MathABOps);
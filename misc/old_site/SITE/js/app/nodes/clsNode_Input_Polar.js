...
//MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS
clsNode_Input_Polar = function(props){

		//save our type name
		this.typeName = 'Input_Polar';
	...
	//CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION
		...
		this.NODE.addAttribute({'caption':'Polar coordinates', 	'CRTLType':'HTML', 															'CRTLProps':{'defaultValue':'These will change at run-time.'} 	});
		this.NODE.addAttribute({'caption':'Theta', 				'CTRLType':'FLOAT_VALUE', 	'output':{'name':'theta', 	'type':'float'},	'CRTLProps':{'locked':true}		});
		this.NODE.addAttribute({'caption':'Radius', 			'CTRLType':'FLOAT_VALUE', 	'output':{'name':'radius', 	'type':'float'},	'CRTLProps':{'locked':true}		});
...
//GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS
	...
	clsNode_Input_Polar.prototype.getModelAttrs = function(){
		return {};
...
//GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS
	...
	clsNode_Input_Polar.prototype.model = function(inputs){
	...
	clsNode_Input_Polar.prototype.update = function(){
...
//EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS
	...
	clsNode_Input_Polar.prototype.raiseEvent = {};


	//CHANGE EVENT +++ CHANGE EVENT +++ CHANGE EVENT
	clsNode_Input_Polar.prototype.raiseEvent.change = function(me){
	...
	clsNode_Input_Polar.prototype.onChange = function(callBackFunction){
...
nodeCreationMenu.registerNodeMenuItem('Polar Coords.', ['Input'], clsNode_Input_Polar);
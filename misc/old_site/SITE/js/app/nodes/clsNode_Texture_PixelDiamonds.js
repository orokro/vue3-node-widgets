...
//MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS
clsNode_Texture_PixelDiamonds = function(props){

		//save our type name
		this.typeName = 'Texture_PixelDiamonds';
	...
	//CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION
		...
		this.NODE.setTitle('Texture &#9658; Diamonds');

		//build our nodes attributes
		this.NODE.addAttribute({'caption':'Checker Width:', 	'CTRLType':'INT_VALUE', 	'input':{'name':'w', 		'type':'int'}, 		'output':{'name':'w', 		'type':'int'},		'CRTLProps':{'defaultValue':'10', 'domain':'+'}		});
		this.NODE.addAttribute({'caption':'Checker Height:', 	'CTRLType':'INT_VALUE', 	'input':{'name':'h', 		'type':'int'}, 		'output':{'name':'h', 		'type':'int'},		'CRTLProps':{'defaultValue':'10', 'domain':'+'}		});
...
//GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS
	...
	clsNode_Texture_PixelDiamonds.prototype.getModelAttrs = function(){
...
//GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS
	...
	clsNode_Texture_PixelDiamonds.prototype.model = function(inputs){
		...
		var x = Math.abs( inputs.x );// - ((inputs.x<0) ? w : 0) ); 
		var y = Math.abs( inputs.y );//- ((inputs.y<0) ? h : 0) );
		...
		if( (localX<= w/2 && localY<=h/2) || (localX> w/2 && localY>h/2) )
			white=true;
	...
	clsNode_Texture_PixelDiamonds.prototype.update = function(){
...
//EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS
	...
	clsNode_Texture_PixelDiamonds.prototype.raiseEvent = {};


	//CHANGE EVENT +++ CHANGE EVENT +++ CHANGE EVENT
	clsNode_Texture_PixelDiamonds.prototype.raiseEvent.change = function(me){
	...
	clsNode_Texture_PixelDiamonds.prototype.onChange = function(callBackFunction){
...
nodeCreationMenu.registerNodeMenuItem('Pixel Diamonds', ['Texture'], clsNode_Texture_PixelDiamonds);
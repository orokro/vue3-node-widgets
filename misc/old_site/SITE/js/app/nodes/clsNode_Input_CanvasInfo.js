...
//MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS
clsNode_Input_CanvasInfo = function(props){

		//save our type name
		this.typeName = 'Input_CanvasInfo';
	...
	//CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION
		...
		this.NODE.setTitle('Input &#9658; Canvas Info');

		//build our nodes attributes
		this.NODE.addAttribute({'caption':'Canvas Details', 	'CRTLType':'HTML', 															'CRTLProps':{'defaultValue':'These will change at run-time.'} 	});
		this.NODE.addAttribute({'caption':'Width', 				'CTRLType':'INT_VALUE', 	'output':{'name':'width', 	'type':'int'},	'CRTLProps':{'locked':true}		});
		this.NODE.addAttribute({'caption':'Height', 			'CTRLType':'INT_VALUE', 	'output':{'name':'height', 	'type':'int'},	'CRTLProps':{'locked':true}		});
...
//GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS
	...
	clsNode_Input_CanvasInfo.prototype.getModelAttrs = function(){
		return 	{
					'width':1,
					'height':1
				}
...
//GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS
	...
	clsNode_Input_CanvasInfo.prototype.model = function(inputs){
	...
	clsNode_Input_CanvasInfo.prototype.update = function(){
...
//EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS
	...
	clsNode_Input_CanvasInfo.prototype.raiseEvent = {};


	//CHANGE EVENT +++ CHANGE EVENT +++ CHANGE EVENT
	clsNode_Input_CanvasInfo.prototype.raiseEvent.change = function(me){
	...
	clsNode_Input_CanvasInfo.prototype.onChange = function(callBackFunction){
...
nodeCreationMenu.registerNodeMenuItem('Canvas Info', ['Input'], clsNode_Input_CanvasInfo);
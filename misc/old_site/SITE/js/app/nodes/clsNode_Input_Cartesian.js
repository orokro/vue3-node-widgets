...
//MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS
clsNode_Input_Cartesian = function(props){

		//save our type name
		this.typeName = 'Input_Cartesian';
	...
	//CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION
		...
		this.NODE.setTitle('Input &#9658; Cartesian');

		//build our nodes attributes
		this.NODE.addAttribute({'caption':'Cartesian coordinates', 	'CRTLType':'HTML', 													'CRTLProps':{'defaultValue':'These will change at run-time.'} 	});
		this.NODE.addAttribute({'caption':'Coordinate System:',		'CTRLType':'DROPBOX', 												'CRTLProps':{'items':['CURSOR (Relative)','CANVAS (Global)']}	});
		this.NODE.addAttribute({'caption':'X', 						'CTRLType':'INT_VALUE', 	'output':{'name':'x', 	'type':'int'},	'CRTLProps':{'locked':true}		});
		this.NODE.addAttribute({'caption':'Y', 						'CTRLType':'INT_VALUE', 	'output':{'name':'y', 	'type':'int'},	'CRTLProps':{'locked':true}		});
...
//GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS
	...
	clsNode_Input_Cartesian.prototype.getModelAttrs = function(){
		return {	
					'coordSystem': this.NODE.getCTRL(1).getValue()
				};
...
//GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS
	...
	clsNode_Input_Cartesian.prototype.model = function(inputs){
	...
	clsNode_Input_Cartesian.prototype.update = function(){
...
//EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS
	...
	clsNode_Input_Cartesian.prototype.raiseEvent = {};


	//CHANGE EVENT +++ CHANGE EVENT +++ CHANGE EVENT
	clsNode_Input_Cartesian.prototype.raiseEvent.change = function(me){
	...
	clsNode_Input_Cartesian.prototype.onChange = function(callBackFunction){
...
nodeCreationMenu.registerNodeMenuItem('Cartesian Crds.', ['Input'], clsNode_Input_Cartesian);
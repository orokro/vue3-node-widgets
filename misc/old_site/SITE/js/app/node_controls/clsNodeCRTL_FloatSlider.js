/*
	...
	This class defines the logic for a slider control.
...
//MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS
clsNodeCRTL_FloatSlider = function(parent, props){
	...
	//MEMBER VARIABLES +++ MEMBER VARIABLES +++ MEMBER VARIABLES +++ MEMBER VARIABLES
		...
		this.mvarMinVal = (typeof props.minValue === "undefined") ? 0.0 : props.minValue;
		this.mvarMaxVal = (typeof props.maxValue === "undefined") ? 1.0 : props.maxValue;
	...
	//CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION
		...
		$(parent).append('<div class="NC_floatSlider"><span>' + this.formatValue() + '</span><input type="text"/></div>');

		//save reference to the this controls primary DOM element
		this.mvarDOM = $(parent).find('.NC_floatSlider');
...
//GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS
	...
	clsNodeCRTL_FloatSlider.prototype.getValue = function(){ return this.mvarVal; };
...
//SETTERS +++ SETTERS +++ SETTERS +++ SETTERS +++ SETTERS +++ SETTERS
	...
	clsNodeCRTL_FloatSlider.prototype.setValue = function(val, nofire){
	...
	clsNodeCRTL_FloatSlider.prototype.setLocked = function(bool){
...
//GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS
	...
	clsNodeCRTL_FloatSlider.prototype.doEditMode = function(event){
	...
	clsNodeCRTL_FloatSlider.prototype.endEditMode = function(event){
	...
	clsNodeCRTL_FloatSlider.prototype.startValueDrag = function(event){
	...
	clsNodeCRTL_FloatSlider.prototype.doValueDrag = function(deltaX, deltaY){
	...
	clsNodeCRTL_FloatSlider.prototype.rangeTrimVal = function(val){
	...
	clsNodeCRTL_FloatSlider.prototype.formatValue = function(){
...
//EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS
	...
	clsNodeCRTL_FloatSlider.prototype.raiseEvent = {};


	//CHANGE EVENT +++ CHANGE EVENT +++ CHANGE EVENT
	clsNodeCRTL_FloatSlider.prototype.raiseEvent.change = function(me){
	...
	clsNodeCRTL_FloatSlider.prototype.onChange = function(callBackFunction){

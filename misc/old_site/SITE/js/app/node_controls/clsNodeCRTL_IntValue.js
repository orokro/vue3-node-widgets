...
//MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS +++ MAIN CLASS
clsNodeCRTL_IntValue = function(parent, props){
	...
	//CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION +++ CONSTRUCTION
		...
		$(parent).append('<div class="NC_intValue"><span>' + this.formatValue() + '</span><input type="text"/></div>');

		//save reference to the this controls primary DOM element
		this.mvarDOM = $(parent).find('.NC_intValue');
...
//GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS +++ GETTERS
	...
	clsNodeCRTL_IntValue.prototype.getValue = function(){ return this.mvarVal; };
	clsNodeCRTL_IntValue.prototype.getDomain = function(){ return this.mvarDomain; };
...
//SETTERS +++ SETTERS +++ SETTERS +++ SETTERS +++ SETTERS +++ SETTERS
	...
	clsNodeCRTL_IntValue.prototype.setValue = function(val, nofire){
	...
	//set the domain
	clsNodeCRTL_IntValue.prototype.setDomain = function(domain){
	...
	clsNodeCRTL_IntValue.prototype.setLocked = function(bool){
...
//GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS +++ GENERAL METHODS
	...
	clsNodeCRTL_IntValue.prototype.doEditMode = function(event){
	...
	clsNodeCRTL_IntValue.prototype.endEditMode = function(event){
	...
	clsNodeCRTL_IntValue.prototype.startValueDrag = function(event){
	...
	clsNodeCRTL_IntValue.prototype.doValueDrag = function(deltaX, deltaY){
	...
	clsNodeCRTL_IntValue.prototype.formatValue = function(){
...
//EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS +++ EVENTS
	...
	clsNodeCRTL_IntValue.prototype.raiseEvent = {};


	//CHANGE EVENT +++ CHANGE EVENT +++ CHANGE EVENT
	clsNodeCRTL_IntValue.prototype.raiseEvent.change = function(me){
	...
	clsNodeCRTL_IntValue.prototype.onChange = function(callBackFunction){
